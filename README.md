...
- Normalize official releases with the import scripts in `tools/` (e.g., `python3 tools/import_loinc.py ...`, `python3 tools/import_icd10.py ...`, `python3 tools/import_snomed.py ...`). The loaders automatically prefer these normalized tables when present.
